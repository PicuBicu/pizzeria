<header class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mb-4 border-bottom">
    ...
    <div class="col-md-3 text-end">
        ...
        if ($_SESSION["loggedin"]) {
            echo "<button type='button' class='btn btn-primary'><a href='../logout.php'>Wyloguj się</a></button>";
        } else {
            echo "<button type='button' class='btn btn-outline-primary me-2'><a href='../login.php'>Zaloguj się</a></button>";
            echo "<button type='button' class='btn btn-primary'><a href='../register.php'>Zarejestruj się</a></button>";
        }
        ?>
    </div>
</header>